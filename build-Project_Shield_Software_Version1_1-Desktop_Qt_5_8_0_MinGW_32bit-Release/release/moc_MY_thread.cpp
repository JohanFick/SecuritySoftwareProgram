...
#include "../../Project_Shield_Software_Version1_1/MY_thread.h"
...
QT_MOC_LITERAL(4, 41, 12), // "socket_error"
QT_MOC_LITERAL(5, 54, 9), // "readyRead"
QT_MOC_LITERAL(6, 64, 10), // "disconnect"
QT_MOC_LITERAL(7, 75, 12) // "safevariable"

    },
    "MY_Thread\0error\0\0QTcpSocket::SocketError\0"
    "socket_error\0readyRead\0disconnect\0"
    "safevariable"
};
...
void MY_Thread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (MY_Thread::*_t)(QTcpSocket::SocketError );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MY_Thread::error)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void MY_Thread::error(QTcpSocket::SocketError _t1)
{
